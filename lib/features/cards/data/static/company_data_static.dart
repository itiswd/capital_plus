...
List<CompanyDataModel> companyData = [
  ...
  CompanyDataModel(
      ...
      interstingFacts:
          "Amazon Prime, launched in 2005, has been a key growth driver for the company, offering users free shipping and access to a wide range of digital services for a flat annual fee. As of 2023, more than 200 million people worldwide are subscribed to Amazon Prime. The service has significantly increased customer loyalty, boosted sales revenue and enabled Amazon to dominate the e-commerce industry.",
      trailingModel: TrailingModel(
        subtitle:
            "Trailing total returns as of 8/23/2024, which may include dividends or other distributions. Benchmark is S&P 500.",
        yearReturn1: YearReturn(
  ...
  CompanyDataModel(
      ...
      companyHistory:
          "Microsoft was founded in 1975 by Bill Gates and Paul Allen. The company gained prominence with the launch of the MS-DOS operating system in the 1980s, followed by the success of Windows in the 1990s. Over the years, Microsoft has diversified into other markets, including cloud computing with its Azure platform and gaming with Xbox. Today, it is one of the largest technology companies in the world.",
      interstingFacts:
          "In 1986, Microsoft went public and its IPO made several employees millionaires. Bill Gates became the youngest billionaire in the world at the time, at just 31 years old. Today, Microsoft is one of the few companies with a market capitalization exceeding \$2 trillion.",
      trailingModel: TrailingModel(
        subtitle:
            "Trailing total returns as of 8/26/2024, which may include dividends or other distributions. Benchmark is S&P 500.",
        yearReturn1: YearReturn(
